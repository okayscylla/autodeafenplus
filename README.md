...
AutoDeafen+ is a small Geometry Dash mod offering automatic Discord deafening on both Linux and Windows.

## Contributing

Contributions / pull requests are welcome, I only ask that no AI would be used in the programming or development process.

## Issues

Issues and bugs can be reported either here or by DMing me on Discord (username: okayscylla)
